              ...
              <div className="lessons-grid">
                <div className="lesson-item">
                  ...
                  <div className="lesson-content">
                    ...
                    <p>تحقق المجمعات السكنية عائداً استثمارياً يتراوح بين 15-18% سنوياً، وهو أعلى من عائد الفنادق في المناطق الصناعية الذي لا يتجاوز 8.5%.</p>
                  </div>
                </div>
                ...
                <div className="lesson-item">
                  ...
                  <div className="lesson-content">
                    <h4>نسب الإشغال</h4>
                    <p>تمتاز المجمعات السكنية بنسب إشغال عالية (90-95%) مقارنة بالفنادق التي لا تتجاوز نسبة إشغالها 35% في المناطق الصناعية.</p>
                  </div>
                </div>
                ...
                <div className="lesson-item">
                  ...
                  <div className="lesson-content">
                    ...
                    <p>تنخفض تكاليف تشغيل المجمعات السكنية بنسبة 30% مقارنة بالفنادق، مع زيادة في الإيرادات.</p>
                  </div>
                </div>
