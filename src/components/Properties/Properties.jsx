    ...
    <section id="properties" ref={sectionRef} className="section properties-section">
      <div className="container">
        ...
        <p className="section-description">
          تتوفر 15 قطعة أرض في حي المصفاة بجنوب الرياض وبجوار المنطقة الصناعية الثانية، بمساحة إجمالية تقارب 37,800 متر مربع، مثالية لتطوير مجمعات سكنية عالية الجودة للعمال والموظفين.
        </p>
